...
const Inbox: React.FC<InboxProps> = ({ isAccountOwner, onNewFax, selectedFax: initialSelectedFax, onFaxSelected }) => {
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredFaxes.map((fax) => (
              <tr key={fax.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{fax.fromNumber}</td>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <div className="text-sm text-gray-500 space-y-1">
                    <p>From: {selectedFax.fromNumber}</p>
                    <p>To: {selectedFax.toNumber} ({selectedFax.assignedUser})</p>
